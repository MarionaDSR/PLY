...
function scene:create( event )
	...
	local titleShadow = display.newText(sceneGroup, GAME_TITLE, TITLE_X + TITLE_SHADOW, TITLE_Y + TITLE_SHADOW, BOLD_FONT, TITLE_SIZE)
	titleShadow:setFillColor(getColor(TITLE_SHADOW_COLOR))
	local title = display.newText(sceneGroup, GAME_TITLE, TITLE_X, TITLE_Y, BOLD_FONT, TITLE_SIZE)
	...
	local buttonText = display.newText(sceneGroup, PLAY_TEXT, PLAY_X, PLAY_Y, BOLD_FONT, PLAY_TEXT_SIZE)
